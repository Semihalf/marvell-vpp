...
export STARTUP_PARAMETERS="unix { interactive nodaemon log /tmp/vpp.log cli-listen /run/vpp/cli.sock } api-trace { on } cpu { workers 1 } dpdk { vdev net_mrvl,iface=eth0,iface=eth2 vdev crypto_mrvl no-multi-seg num-mbufs 8192 socket-mem 64 }"
